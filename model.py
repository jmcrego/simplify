...
class Model(nn.Module):
    ...
    def __init__(self, cfg, voc, emb, dropout=0.0):
        ...
        self.decoder = DecoderRNN_Attn(self.embeddings, self.cfg.cell, self.cfg.num_layers, self.cfg.bidirectional, self.cfg.hidden_units, dropout, self.cfg.attention, voc.idx_ini, voc.idx_end, voc.idx_pad, voc.idx_unk, cfg.cuda)
